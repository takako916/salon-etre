...
export default function Exposants() {
  return (
    <div className="max-w-5xl mx-auto py-8 px-2">
      <h1 className="text-center text-2xl text-[#218393] mb-8 font-playfair">Exposants Salon de l&apos;être Blavozy 2025 :<br /> 
      +40 Professionnels du Bien-être, Massage, Réflexologie, Kinésiologie, Magnétisme <br />
       10-12 Octobre 2025</h1>
