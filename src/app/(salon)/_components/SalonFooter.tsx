...
export default function SalonFooter() {
  return (
    <footer className="py-6 px-2 md:px-8 bg-salon-footer">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        <div className="flex-shrink-0 flex items-center justify-center w-full md:w-auto gap-3">
          <a
            href="https://production-directe.com"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Production Directe"
            className="hover:opacity-80"
          >
            <Image src="/images/logo-transparent.png" alt="Production Directe" width={60} height={60} className="drop-shadow-md" />
          </a>
          <a href="https://www.facebook.com/profile.php?id=61591921076745" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-80">
          ...
          <a href="https://www.instagram.com/bien.etre43/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:opacity-80">
        ...
        <div className="text-center flex-1">
          <div className="font-semibold">Salon du bien-être 2026<br />Blavozy</div>
          <div className="text-xs text-gray-800 mt-1">©Production Directe</div>
        </div>
        <Link href="/lieu" prefetch={false} className="text-right text-sm md:text-base space-y-1 block cursor-pointer hover:bg-white/20 rounded transition p-2">
          <div className="font-bold flex items-center justify-end gap-1">
            <span className="inline-block align-middle">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-salon-accent mr-1">
            ...
            {salon2026.dates.labelShort}
            <span className="block font-normal text-sm mt-0.5">
              {salon2026.hours} (les deux jours)
            </span>
          </div>
          <div className="text-sm text-gray-700">
            {salon2026.pricing.full} · Parking gratuit
          </div>
          <div className="flex items-center justify-end gap-1">
            ...
            <span className="font-semibold text-salon-accent">Centre socio-culturel de Blavozy</span>
          </div>
        </Link>
      </div>
    </footer>
