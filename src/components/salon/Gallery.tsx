...
export default function Gallery() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-8">
      <h2 className="text-2xl font-bold text-salon-accent mb-6 text-center font-playfair">
      ...
      <div className="relative flex items-center justify-center">
        ...
        >
          <svg className="w-5 h-5 md:w-6 md:h-6 text-salon-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
